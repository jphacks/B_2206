...
func NewValueRepository(client db.Client) ValueRepository{
	return &valueRepository{client}
}

//全件取得
func (pir *valueRepository) All(c context.Context) (*sql.Rows, error){
...
//1件取得
func (pir *valueRepository) Find(c context.Context, id string) (*sql.Row, error){
...
//作成
func (pir *valueRepository) Create(
	c context.Context,
	item string,
	price string,
	quantity string,
...
//編集
func (pir *valueRepository) Update(
	c context.Context,
	id string,
	item string,
	price string,
...
//削除
func (pir *valueRepository) Delete(
	c context.Context,
	id string,
)error {
...
func (pir *valueRepository) AllWithPurchaseOrder(c context.Context) (*sql.Rows, error) {
...
func (pir *valueRepository) FindWithPurchaseOrder(c context.Context, id string) (*sql.Row, error) {
