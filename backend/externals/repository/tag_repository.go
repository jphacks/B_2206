...
func NewTagRepository(client db.Client) TagRepository{
	return &tagRepository{client}
}

//全件取得
func (pir *tagRepository) All(c context.Context) (*sql.Rows, error){
...
//1件取得
func (pir *tagRepository) Find(c context.Context, id string) (*sql.Row, error){
...
func (pir *tagRepository) AllWithPurchaseOrder(c context.Context) (*sql.Rows, error) {
...
func (pir *tagRepository) FindWithPurchaseOrder(c context.Context, id string) (*sql.Row, error) {
